...
class EXPORT AlpsV8Touchpad : public VoodooPS2TouchPadBase {
    typedef VoodooPS2TouchPadBase super;
    OSDeclareDefaultStructors( AlpsV8Touchpad );

public:
    virtual AlpsV8Touchpad * probe(IOService *provider, SInt32 *score);
